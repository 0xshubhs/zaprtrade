    ...
    >
      ...
      >
        <VStack align="flex-start" spacing={4} h="full">
          ...
          <Heading as="h3" size="md" textTransform="uppercase" color="black">
            {title}
          </Heading>
          <Text color="brand.darkTeal" fontWeight="medium">
            {description}
          </Text>
        </VStack>
      </Card>
...
const features = [
  {
    ...
    description: "Execute transactions and list items seamlessly on Flow.",
      ...
      <Container maxW="7xl">
        <VStack spacing={{ base: 12, md: 16 }}>
          <VStack spacing={4} ref={headingRef}>
            ...
            <Box w="120px" h="4px" bg="brand.green" />
          </VStack>
